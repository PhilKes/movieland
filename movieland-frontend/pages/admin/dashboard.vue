        ...
        <v-row>
          ...
          <v-col cols="12" sm="6">
            <stat-card
              ...
              title="Sold Tickets"
              subtitle="Last 7 Days"
              :value="stats.amtSeats"
              :loading="loading"
            />
          </v-col>
          <v-col cols="12" sm="6">
            <stat-card
              :img="stats.highestGrossingMovie.posterPath"
          ...
          <v-col cols="12" sm="6">
            <stat-card
              :img="stats.lowestGrossingMovie.posterPath"
              title="Lowest Grossing"
              subtitle="Last 7 Days"
              :loading="loading"
            >
...
export default {
  ...
  async fetch() {
    ...
    this.stats = await this.$repos.statistics.getSummary(
